...
export const CLIENTS: Client[] = [
  // E-commerce
  { id: "mft", name: "Maison FT", domain: "maisonft.com", sector: "beaute", cms: "Shopify", ecommerce: true, gscProperty: "https://www.maisonft.com/", ga4PropertyId: "375028281", owner: "", active: true },
  { id: "joi", name: "JOÏSTA", domain: "joista.com", sector: "bien-etre", cms: "Shopify", ecommerce: true, gscProperty: "https://joista.com/", ga4PropertyId: "476376599", owner: "", active: true },
  { id: "mor", name: "Morphée", domain: "morphee.co", sector: "bien-etre", cms: "Shopify", ecommerce: true, gscProperty: "sc-domain:morphee.co", ga4PropertyId: "365431125", owner: "", active: true },
  ...
  { id: "mab", name: "Marc-Antoine Barrois", domain: "marcantoinebarrois.com", sector: "beaute", cms: "Shopify", ecommerce: true, gscProperty: "https://marcantoinebarrois.com/", ga4PropertyId: "404921902", owner: "", active: true },
  { id: "chi", name: "Chillow", domain: "mychillow.fr", sector: "bien-etre", cms: "Shopify", ecommerce: true, gscProperty: "https://mychillow.fr/", ga4PropertyId: "", owner: "", active: true },
  ...
  { id: "che", name: "CHERICO", domain: "cherico.fr", sector: "beaute", cms: "Shopify", ecommerce: true, gscProperty: "https://www.cherico.fr/", ga4PropertyId: "425277309", owner: "", active: true },
  ...
  { id: "voo", name: "Vook", domain: "vook.ai", sector: "b2b-services", cms: "Webflow", ecommerce: false, gscProperty: "https://www.vook.ai/", ga4PropertyId: "384070889", owner: "", active: true },
  { id: "ult", name: "Ultra Strategy", domain: "ultrastrategy.com", sector: "b2b-services", cms: "WordPress", ecommerce: false, gscProperty: "sc-domain:ultrastrategy.com", ga4PropertyId: "497700698", owner: "", active: true },
  ...
  { id: "key", name: "Keyrus", domain: "web.keyrus.com", sector: "b2b-services", cms: "Custom", ecommerce: false, gscProperty: "https://web.keyrus.com/", ga4PropertyId: "", owner: "", active: true },
  { id: "bra", name: "Brainologist", domain: "brainologist.fr", sector: "sante", cms: "WordPress", ecommerce: false, gscProperty: "https://brainologist.fr", ga4PropertyId: "467663639", owner: "", active: true },
